...
Responde en español, cálido y conciso (máx 200 palabras). Usa el contexto del perfil y despensa para respuestas personalizadas.`;
    ...
    const res=await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({model:"claude-opus-4-1",max_tokens:1000,system,messages:[...msgHistory,{role:"user",content:txt}]})});
